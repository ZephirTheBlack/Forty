<template>
    <div class="d-flex justify-content-between bg-light p-3 rounded mb-3 shadow-sm">
        ...
        <div>
            <button class="btn btn-info btn-sm rounded text-white" v-if="localFriendshipStatus === 'pending' " dusk="accept-friendship" @click="acceptFriendshipRequest">Aceptar solicitud</button>
            <button class="btn btn-info btn-sm rounded text-white" v-if="localFriendshipStatus === 'pending' " dusk="deny-friendship" @click="denyFriendshipRequest">Denegar solicitud</button>
            <button class="btn btn-info btn-sm rounded text-white" v-if="localFriendshipStatus !== 'deleted'" dusk="delete-friendship" @click="deleteFriendship">Eliminar solicitud</button>
        </div>
    </div>
</template>
