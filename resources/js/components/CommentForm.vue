<template>
    <form @submit.prevent="addComment" v-if="isAuthenticated" class="mb-3">
        <div class="d-flex align-items-center">
            ...
            <div class="input-group">
                <textarea class="form-control border-0 shadow-sm" name="comment" required v-model="newComment" rows="1" placeholder="Escribe tu comentario..."></textarea>
    ...
    <div v-else class=" text-center mb-3">Debes <a href="/login">autenticarte</a> para poder comentar</div>
</template>
